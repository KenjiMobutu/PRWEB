	...
	$(function () {
		...
		validation
			...
			.onSuccess(function (event) {
				...
				$.ajax({
					url: '/prwb_2223_c03/main/signup', // the URL where you want to submit the form data
					type: 'POST',
					data: formData,
					...
					error: function(jqXHR, textStatus, errorThrown) {
						// handle errors here
						console.log('Error: An error occurred while submitting the form:', errorThrown);
						alert('Oops! An error occurred while processing your registration. Please try again.');
					}
				});
			});
