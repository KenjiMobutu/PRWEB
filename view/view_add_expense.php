...
<body>
    ...
    <div class="add-exp">
        ...
        <form action="operation/add_expense" method="post">
                ...
                <input class="addExp" placeholder="Title" type="text" id="title" name="title" <?php
                ...
                <select id="rti" name="rti">
                    <?php if (isset($_POST["rti"])):
                        echo '<option style="color: black;" value=' . $template->get_id() . ">" . $template->get_title() . "</option>"; endif; ?>
